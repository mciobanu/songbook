...
export const FirstNoteWidget = ({
    ...
    lastInList: boolean,  //ttt1: do something about this hack: get rid of songNormalVerse in ChordsArea and add some space after whatever happens to be the last
}) => {
    const shiftedFirstNote = React.useMemo(() => {
        ...
        //ttt1: substituteChords() is like in JS, but perhaps substituteChord() is good enough. Is it for things like "Am(C)" in "Om bun"? (It doesn't work in that case, and here we have a single note anyway)
